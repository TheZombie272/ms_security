package com.danielflores38153.ms_security.Interceptors;
...
public class SecurityInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request,
                             ...
                             Object handler)
            throws Exception {
        return this.validatorService.validationRolePermission(request,request.getRequestURI(),request.getMethod());
    }
